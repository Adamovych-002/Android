...
class DetailActivity : AppCompatActivity() {
    ...
    private val duck= AnimalClass(name = "Duck",
        description = "До родини акул-молотів належать 2 роди із сімома видами. \n" +
                "Акули-молоти є родичами сірим акулам, але відрізняються від них, \n " +
                "а також від всіх інших риб дуже своєрідною формою голови. \n" +
                " Вона сильно сплющена зверху вниз і має з боків два більших вирости, \n" +
                "на зовнішніх краях яких розташовані очі, а трохи попереду від них — більші ніздрі.\n",R.mipmap.duck)
